...
const NavLinks = () => {
  ...
  return (
    <>
      <div
        className={`flex items-center justify-center lg:gap-6 gap-4 lg:flex-row flex-col absolute inset-x-0 lg:static z-40 bg-white lg:bg-transparent mx-4 transition-all duration-500 rounded-lg p-4 shadow-lg lg:shadow-none ${
